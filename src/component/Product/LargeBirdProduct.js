...
const LargeBirdProduct = () => {
    ...
    const getLargeBirdProduct = async () => {
        const config = {
            header: {
        ...
        try {
            const { data } = await axios.get("https://mak-personal-project-server.herokuapp.com/home/auth/getLargeBirdProduct", config)
            setProduct(data);
            setLoadProduct(true);
...
export default LargeBirdProduct;
